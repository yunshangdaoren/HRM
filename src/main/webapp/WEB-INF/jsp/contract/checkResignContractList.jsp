...
<body>
	...
	<div id="center">
		...
		<div id="right">
			<ul class="nav nav-tabs">
  				...
  				<li role="presentation" class="active"><a href="/contract/toCheckResignContractList.do">离职合同审批</a></li>
			</ul>
			<div class="div_search">
				<form class="form-inline" id="form-queryDept" method="get" action="/contract/toCheckResignContractList.do">
				...
				<tbody>
					<c:forEach items="${pageResult.content }" var="contract">
						<tr>
							...
							<td>
								<a href="#" class="a-operatorEmpName">${department.entryCheckEmpName }</a>
								<i style="display:none;">${department.entryCheckEmpjobid }</i>
							</td>
							<td>
	...
	<script type="text/javascript" src="/static/js/contract/checkResignContractList.js"></script>
</html>