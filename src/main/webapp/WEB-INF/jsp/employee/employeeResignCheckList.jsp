...
<head>
<meta charset="UTF-8">
	<title>待审批职工离职申请信息</title>
	<link href="/static/css/employee/employeeResignCheckList.css" rel="stylesheet" />
</head>
<body>
	...
	<div id="center">
		...
		<div id="right">
			<ul class="nav nav-tabs">
  				<li role="presentation"><a href="/employeeResign/toEmployeeResignList.do">所有离职申请单列表</a></li>
					...
					<c:forEach items="${pageResult.content }" var="employeeResign">
						<tr>
					    	...
					    	<td>
					    		...
					    		<a style="text-decoration:none" class="a_checkEmployeeResign" href="#">
