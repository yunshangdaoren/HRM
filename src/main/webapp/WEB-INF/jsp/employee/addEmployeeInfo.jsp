			...
			<div class="div_addEmployeeInfo">
				<form style="width:100%;" id="form-addEmployeeInfo" class="form-horizontal" role="form">
    				...
    				<div class="form-group" style="margin-top:10px;">
  					...
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工所属部门</label>
    					<div class="col-sm-8">
  					...
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工所属职位</label>
    					<div class="col-sm-8">
  					...
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工出生日期</label>
    					<div class="col-sm-8">
    						<input type="text" readonly="readonly" class="form-control" name="empBirthday" value="${empBirthdayStr }">
    					</div>
  					</div>
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工身份证号码</label>
    					<div class="col-sm-8">
      						<input type="text" readonly="readonly" class="form-control" name="empIdcard" value="${contract.empIdcard }">
    					</div>
  					</div>
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工联系电话</label>
    					<div class="col-sm-8">
      						<input type="text" class="form-control" name="empPhone">
    					</div>
  					</div>
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工邮箱</label>
    					<div class="col-sm-8">
  					...
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工学历</label>
    					<div class="col-sm-8">
      						<input type="text" class="form-control" name="empEducation">
    					</div>
  					</div>
  					<div class="form-group" style="margin-top:10px;">
    					<label for="firstname" class="col-sm-3 control-label">职工家庭住址</label>
    					<div class="col-sm-8">
      						<input type="text" class="form-control" name="empAddress">
    					</div>
  					</div>
  					<div class="form-group">
    					<label for="lastname" class="col-sm-3 control-label">职工状态</label>
    					<div class="col-sm-8">
