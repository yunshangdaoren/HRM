...
<head>
<meta charset="UTF-8">
	<title>我的离职申请信息</title>
	<link href="/static/css/employee/myEmployeeResignList.css" rel="stylesheet" />
</head>
<body>
	...
	<div id="center">
		...
		<div id="right">
			<span class="title">我的离职申请信息</span>
			<div class="div_search">
				<form class="form-inline" id="form-queryDept" method="get" action="/employeeResign/toMyEmployeeResignList.do">
					<div class="form-group">
  					...
  					<button id="btn-toAddEmployeeResignInfo" type="button" class="btn btn-success">离职申请</button>
				</form>
			</div>
	...
	<script type="text/javascript" src="/static/js/employee/myEmployeeResignList.js"></script>
</html>