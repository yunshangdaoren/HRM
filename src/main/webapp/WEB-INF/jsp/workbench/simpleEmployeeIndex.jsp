					...
					<div class="div1">
						<div class="panel panel-primary" id="div_attendanceEmployee">
  							...
  							<div class="panel-body" title="上班打卡">
    							<div class="div-personNum">
    								<c:choose>
										<c:when test="${attendanceEmployee.signTime!=null }">
											<span class="num" style="line-height:70px;font-size:25px;color:green;">今日已打</span>
										</c:when>
										<c:otherwise>
											<span class="num" id="span_sign" style="line-height:70px;font-size:25px;color:red;">今日未打</span>
										</c:otherwise>
									</c:choose>
    							</div>
    							<div class="div-img">
    								<c:choose>
										<c:when test="${attendanceEmployee.signTime!=null }">
											<img class="img_sign" src="/static/img/signSuccess.png" style="width:52px;height:52px;">
										</c:when>
										<c:otherwise>
											<img class="img_sign" src="/static/img/signFail.png" style="width:52px;height:52px;">
										</c:otherwise>
									</c:choose>
    							</div>
  							</div>
						...
						<div class="panel panel-success" onclick="window.open('')">
  							...
  							<div class="panel-body" title="下班打卡">
    							<div class="div-personNum">
    								<span class="num" id="span_logout" style="line-height:70px;font-size:25px;color:red;">今日未打</span>
    							</div>
    							<div class="div-img">
    								<img class="img_logout" src="/static/img/signFail.png">
    							</div>
  							</div>
						</div>
					</div>
