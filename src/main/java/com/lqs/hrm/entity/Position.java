...
public class Position {
	...
	public String toString() {
		return "Position [positionId=" + positionId + ", positionName=" + positionName + ", positionDesc="
				+ positionDesc + ", plId=" + plId + ", plLeve=" + plLeve + ", deptId=" + deptId + ", deptName="
				+ deptName + ", parentPositionid=" + parentPositionid + ", parentPositionName=" + parentPositionName
				+ ", statusId=" + statusId + ", statusName=" + statusName + ", lastOperatorDate=" + lastOperatorDate
